...
game1.print();
console.log("Expected: Player 1, Actual:", game1.getWinner());
...
game2.print();
console.log("Expected: Player 2, Actual:", game2.getWinner());
...
game3.print();
console.log("Expected: Player 1, Actual:", game3.getWinner());
...
game4.print();
console.log("Expected: Player 2, Actual:", game4.getWinner());
...
game5.print();
console.log("Expected: Player 1, Actual:", game5.getWinner());
...
game6.print();
console.log("Expected: Player 2, Actual:", game6.getWinner());
...
game7.play(0); // P1
game7.play(5); // P2
game7.play(0); // P1 - wins diagonal
game7.print();
console.log("Expected: Player 1, Actual:", game7.getWinner());
...
game8.print();
console.log("Expected: Player 2, Actual:", game8.getWinner());
